 ...
 */
  ...
  * -------------------------------------------------------------
  */
rigaax_void displayBuffer(BufferPointer ptr_Buffer);
rigaax_long getFileSize(rigaax_strg fname);
rigaax_intg isNumber(const rigaax_strg ns);
rigaax_void startReader(rigaax_strg, rigaax_strg, rigaax_intg, rigaax_real);
...
rigaax_intg main2Reader(rigaax_intg argc, rigaax_strg* argv) {
	...
	rigaax_strg program = argv[0];
	rigaax_strg input = argv[2];
	rigaax_intg size = 0;
	rigaax_real factor = 0.0f;
...
************************************************************
*/
rigaax_void startReader(rigaax_strg program, rigaax_strg input, rigaax_intg size, rigaax_real factor) {
